...
{
  let _old_Sprite_OmoMenuStatusFace_update = Sprite_OmoMenuStatusFace.prototype.update;
  Sprite_OmoMenuStatusFace.prototype.update = function() {
    var actor = this.actor;
    // if actor has tell to update sprite, do update
    if (actor && actor._toUpdateSpriteDelay) {
      this._animDelay = this.defaultDelay();
      actor._toUpdateSpriteDelay = false;
    }
    _old_Sprite_OmoMenuStatusFace_update.call(this);
  };

  // Check on add and remove state to tell to update sprite
  let _old_Game_Battler_addState = Game_Battler.prototype.addState;
  Game_Battler.prototype.addState = function(stateId) {
    _old_Game_Battler_addState.call(this, stateId);
    this._toUpdateSpriteDelay = true;
  };

  let _old_Game_Battler_removeState = Game_Battler.prototype.removeState;
  Game_Battler.prototype.removeState = function(stateId) {
    _old_Game_Battler_removeState.call(this, stateId);
    this._toUpdateSpriteDelay = true;
  };
}
