...
Game_Action.prototype.makeDamageValue = function (target, critical) {
  ...
  return Stahl.DamagePopups.Game_Action_makeDamageValue.call(
    this,
    target,
    critical
  );
...
Game_Battler.prototype.isElementReflect = function (elementId) {
  // Checking for each of the reflection states
  if (elementId == 2 && this.isStateCategoryAffected("HAPPY"))
    return this.isStateCategoryAffected("REFLECT_HAPPY");
  if (elementId == 3 && this.isStateCategoryAffected("SAD"))
    return this.isStateCategoryAffected("REFLECT_SAD");
  if (elementId == 4 && this.isStateCategoryAffected("ANGRY"))
    return this.isStateCategoryAffected("REFLECT_ANGRY");
  if ([2, 3, 4].contains(elementId) && this.isStateCategoryAffected("EMOTION"))
    return this.isStateCategoryAffected("REFLECT_EMOTION");
...
BattleManager.invokeAction = function (subject, target) {
  ...
  if (
    ...
    target.isElementReflect(action.damage.elementId)
  ) {
